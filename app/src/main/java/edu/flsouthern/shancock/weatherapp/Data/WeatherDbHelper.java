...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        // Create a table to hold cat info
    ...
    // Add a new cat to DB
    public void addWeatherEntry (int id, String location, String shortDesc, String date, String max, String min,
                                 String humidity, String pressure, String windSpeed, String degrees) {

        SQLiteDatabase db = this.getWritableDatabase();

        // Create a new map of values, where column names are the keys
        ContentValues values = new ContentValues();
        values.put(WeatherEntry.COLUMN_WEATHER_ID, id);
        values.put(WeatherEntry.COLUMN_LOC_KEY, location);
    ...
    public Cursor getWeatherDay(int id) {
        ...
        // Filter results WHERE "cat_id" = id #
    ...
    public Cursor getAllWeather(int id) {
        SQLiteDatabase db = this.getReadableDatabase();
